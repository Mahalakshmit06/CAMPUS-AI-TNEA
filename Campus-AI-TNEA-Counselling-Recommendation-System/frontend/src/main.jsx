...
function useHashPage() {
  const read = () => {
    ...
    return ["chat", "calculator", "finder"].includes(value) ? value : "chat";
  };
...
function Header({ page }) {
  return (
    <header className="topbar">
      <button className="brand" onClick={() => navigate("chat")} aria-label="Open Campus AI">
...
function PageTabs({ page }) {
  const tabs = [["chat", "01", "Campus AI"], ["calculator", "02", "Cutoff Calculator"], ["finder", "03", "College Finder"]];
  ...
  return (
    <section className="content-section">
      <div className="section-heading">
        <div><span className="section-kicker">01 · RECOMMENDATION ASSISTANT</span><h2>Talk to Campus AI</h2><p>Campus AI collects your profile one detail at a time, then recommends matching college-branch records and answers relevant counselling questions.</p></div>
...
function FinderPage({ meta }) {
  ...
  return <section className="content-section">
    <div className="section-heading"><div><span className="section-kicker">03 · COLLEGE FINDER</span><h2>Find colleges that fit your profile</h2><p>Filter the supplied dataset by cutoff, community, district and branch.</p></div></div>
